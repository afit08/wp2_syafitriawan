    ...
    <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12 mb-0 mb-md-0">
                ...
                <p class="text-muted">Hubungi kami jika anda dalam masalah pembelian atau masalah dalam penjualan dan kami siap bersedia jika anda dalam masalah</p>

                <p><span class="font-weight-bold mr-2">Email:</span><a href="">betamart@gmail.com</a></p>
                <p><span class="font-weight-bold mr-2">Phone:</span><a href="">+62 853 2567 8899</a></p>
